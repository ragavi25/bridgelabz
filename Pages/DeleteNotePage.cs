...
namespace seleniumFundoo.Pages
{
    ...
    {
        IWebDriver driver;
        public DeleteNotePage(IWebDriver currentDriver)
        {
        ...
        [FindsBy(How = How.XPath, Using = "/html[1]/body[1]/div[3]/div[2]/div[1]/div[1]/div[1]/button[1]")]
        private IWebElement txtDelete;
